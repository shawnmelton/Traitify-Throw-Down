...
Webflow.require('ix').init([
  {"slug":"intro","name":"intro","value":{"style":{"opacity":0,"scale":0.1},"triggers":[{"type":"load","stepsA":[{"wait":400},{"opacity":1,"transition":"transform 200ms linear 0ms, opacity 150ms ease-in-out 0ms","scale":1.5},{"transition":"transform 150ms ease-in-out 0ms","scale":1}],"stepsB":[]}]}},
  {"slug":"left-badge","name":"left badge","value":{"style":{"opacity":0,"x":"-100px","y":"0px"},"triggers":[{"type":"load","stepsA":[{"wait":300},{"opacity":1,"transition":"transform 500ms ease-in-out 0ms, opacity 150ms ease-in-out 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"right-badge","name":"right badge","value":{"style":{"opacity":0,"x":"100px","y":"0px"},"triggers":[{"type":"load","stepsA":[{"wait":300},{"opacity":1,"transition":"transform 500ms ease-in-out 0ms, opacity 150ms ease-in-out 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}}
]);
